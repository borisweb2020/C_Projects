...
- `sum_sequence.c` - finds the sum of the sequence ![The sum sequence](misc/sequence.png)
- `factorial.c` - finds the factorial using and without using a recursive algorithm
- `fibonacci.c` - finds a number from the Fibonacci sequence using and without using a recursive algorithm
